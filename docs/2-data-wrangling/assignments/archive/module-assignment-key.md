...
**Alignment:** Questions map to Module 2 lessons—[SQL](../../2.1-sql/), [wrangling](../../2.2-data-wrangling/), [EDA](../../2.3-eda/), [data engineering](../../2.4-data-engineering/).
...
10. Which scaling method is most robust to outliers? a. Standard scaling (z-score) b. **Robust scaling (using quartiles)** c. Min-max scaling d. Log transformation
