...
**Prerequisites:** [SQL (Module 2.1)](../2.1-sql/), [wrangling (Module 2.2)](../2.2-data-wrangling/), and [EDA (Module 2.3)](../2.3-eda/) at a practical level. Python 3 and **pandas** for examples.
...
2. **Required Libraries**:
   ...
   * **Testing**:
     ...
     * great\_expectations: Data validation
