# Code Execution Output: model-interpretation.md

This file contains the output from running the code blocks in `model-interpretation.md`.
...
Output:
```
Error: cannot import name 'plot_partial_dependence' from 'sklearn.inspection' (/opt/anaconda3/lib/python3.12/site-packages/sklearn/inspection/__init__.py)
...
Sample values: {'Income': 67450.71229516849, 'Age': 26.710049890779274, 'Education_High School': False, 'Education_Master': True, 'Education_PhD': False, 'MaritalStatus_Married': True, 'MaritalStatus_Single': False}
