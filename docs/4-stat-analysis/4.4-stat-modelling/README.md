...
- [Regression basics from module 4.3](../4.3-rship-in-data/README.md), especially [simple](../4.3-rship-in-data/simple-linear-regression.md) and [multiple linear regression](../4.3-rship-in-data/multiple-linear-regression.md).
