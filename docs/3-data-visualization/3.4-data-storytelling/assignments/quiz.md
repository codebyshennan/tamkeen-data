...
1. The SCR framework structures a data story in three parts. Which sequence is correct?

- [ ] Summary → Chart → Recommendation
- [ ] Situation → Complication → Resolution
- [ ] Setup → Context → Review
- [ ] Story → Conflict → Result
...
2. According to the lesson, what is the primary purpose of a "hook" at the opening of a data story?

- [ ] To display the most complex chart first
- [ ] To summarize all findings on one slide
- [ ] To grab attention and make the audience want to keep listening
- [ ] To establish the technical methodology before presenting results
...
3. A data analyst titles a chart "Sales by Month". According to the visual storytelling lesson, what is the problem with this title?

- [ ] It is too long to fit on a slide
- [ ] It describes the data rather than stating the insight
- [ ] It should include the year in the title
- [ ] Titles on charts are unnecessary if there is a legend
...
4. Which color scheme is most appropriate for a chart showing customer satisfaction scores that range from very negative to very positive, with a neutral midpoint?

- [ ] Sequential (single hue, light to dark)
- [ ] Qualitative (maximum contrast between distinct hues)
- [ ] Diverging (two opposing hues with neutral center)
...
5. You are presenting a finding to a CFO who has 5 minutes for your update. Which storytelling framework does the lesson recommend for this scenario?

- [ ] Classic Narrative Arc (Hook → Setup → Journey → Reveal → Call to Action)
- [ ] SCR Framework (Situation → Complication → Resolution)
- [ ] SWOT analysis (Strengths, Weaknesses, Opportunities, Threats)
- [ ] Pyramid principle (conclusion first, then supporting details)
...
6. An analyst annotates a time-series chart with the label "Jet age begins (1955)" at a spike in passenger numbers. What storytelling principle does this annotation serve?

- [ ] It reduces chart junk by replacing axis labels
- [ ] It explains why the trend changed, adding context a line alone cannot provide
- [ ] It makes the chart colorblind-accessible
- [ ] It replaces the need for a written caption below the chart
...
7. A colleague's bar chart has its y-axis starting at 90 instead of 0. According to the visual storytelling lesson, what is the effect of this choice?

- [ ] It makes the chart faster to render
- [ ] It visually exaggerates the differences between bars
- [ ] It correctly zooms in to show fine-grained variation
- [ ] It is only a problem if the bars represent percentages
...
10. The visual storytelling lesson warns that a pie chart becomes unreadable beyond a certain number of slices. What does the lesson recommend instead for data with many categories?

- [ ] A donut chart with the total in the center
- [ ] A stacked bar chart showing all categories at once
- [ ] A sorted bar chart
