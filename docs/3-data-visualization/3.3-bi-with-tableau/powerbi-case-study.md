...
![Power BI Desktop start page](../../../.gitbook/assets/powerbi_start_page.png)

### 2. Understanding the Power BI Workspace

![Power BI workspace overview](../../../.gitbook/assets/powerbi_workspace.png)
...
![Power BI Data View showing Orders table](../../../.gitbook/assets/powerbi_modeling.png)
...
![Power BI Model View with table relationships](../../../.gitbook/assets/powerbi_data_model.png)
...
![Power BI first chart, Sales by Category](../../../.gitbook/assets/powerbi_first_chart.png)
...
![Power BI dual-axis line chart](../../../.gitbook/assets/powerbi_line_chart.png)
...
![Power BI map visualization by state](../../../.gitbook/assets/powerbi_map.png)
...
![Power BI dashboard canvas with multiple visuals](../../../.gitbook/assets/powerbi_dashboard.png)
...
![Power BI DAX measure formula bar](../../../.gitbook/assets/powerbi_dax.png)
...
![Power BI Manage Parameters dialog](../../../.gitbook/assets/powerbi_parameter.png)
...
![Power BI publish to workspace dialog](../../../.gitbook/assets/powerbi_publish.png)
...
![Power BI Power Query Editor with applied steps](../../../.gitbook/assets/powerbi_query.png)
...
![Power BI AppSource custom visual gallery](../../../.gitbook/assets/powerbi_custom_visuals.png)
...
![Power BI Decomposition Tree and Key Influencers](../../../.gitbook/assets/powerbi_advanced_charts.png)
...
`DATESYTD` returns all dates from Jan 1 to the current date in the filter context, giving a cumulative YTD total.

Prior Year Compare

`SAMEPERIODLASTYEAR` shifts the date filter back exactly one year, enabling clean YoY variance calculations.

3-Month Moving Average

`DATESINPERIOD` with `-3 MONTH` creates a rolling window; `AVERAGEX` iterates over that period and averages sales.

### 2. Advanced Filter Context

Top N Filter

`VAR N` stores the threshold; `TOPN` ranks product names by sales descending and `CALCULATE` applies that set as a filter.

Dynamic Segmentation

`SWITCH(TRUE(), ...)` evaluates conditions in order, the first matching expression wins, replacing a chain of nested IFs.
...
![Power BI Service workspace management page](../../../.gitbook/assets/powerbi_workspace_mgmt.png)
...
![Power BI Service sharing and collaboration dialog](../../../.gitbook/assets/powerbi_collaboration.png)
...
![Power BI Performance Analyzer pane](../../../.gitbook/assets/powerbi_performance.png)
...
![Power BI Service scheduled refresh settings](../../../.gitbook/assets/powerbi_refresh.png)
