...
_`array.shape` is the first thing to check when something goes wrong, most dimension errors come from passing a 1D array where a 2D one is expected (or vice versa)._
...
![numpy\_vs\_list](../../../.gitbook/assets/numpy_vs_python_list.png)
