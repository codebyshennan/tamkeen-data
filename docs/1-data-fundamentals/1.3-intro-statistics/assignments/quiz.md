...
- **Where:** [Probability distribution families](../probability-distribution-families.md).
- **Think:** "Fixed number of trials, each with two outcomes" is the textbook setup for the family whose name comes from "two" (Latin *bi-*).
...
- **Where:** [Probability distribution families](../probability-distribution-families.md).
- **Think:** Binomial is for trials; Normal is for symmetric continuous data. Poisson is for **counts of events in a fixed interval** (e.g. arrivals per minute).
