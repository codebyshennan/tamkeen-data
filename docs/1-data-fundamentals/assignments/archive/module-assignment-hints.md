...
Lesson root: [1.1 Introduction to data analytics](../1.1-intro-data-analytics/).
...
* **Where to look:** [README](../1.1-intro-data-analytics/) - "What is a data analyst?".
...
Lesson root: [1.2 Introduction to Python](../1.2-intro-python/).
...
Lesson root: [1.3 Introduction to Statistics](../1.3-intro-statistics/).
...
* **How to think:** Pearson's _r_ is symmetric: perfect negative is `-1`, no correlation is `0`, perfect positive is `+1`. The full range is bounded on both ends.

### Q9: which measure resists outliers

* **Where to look:** [One-variable statistics](../1.3-intro-statistics/one-variable-statistics.md) - reliable statistics.
...
Lesson root: [1.4 Data foundation: linear algebra & NumPy](../1.4-data-foundation-linear-algebra/).
...
Lesson root: [1.5 Data analysis with pandas](../1.5-data-analysis-pandas/).
