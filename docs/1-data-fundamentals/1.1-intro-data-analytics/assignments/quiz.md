...
- **Where:** [Data Privacy](../data-privacy.md).
- **Think:** "PII" appears almost everywhere in privacy law. The first I is for **information**. The middle word combines "person" with "ability to be identified".
...
- **Where:** [Data Security](../data-security.md).
- **Think:** Encryption transforms readable data into something only the holder of a key can read. That maps directly to one of the four options.
