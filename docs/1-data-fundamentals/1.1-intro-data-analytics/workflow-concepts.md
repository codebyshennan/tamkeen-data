...
_Ken Jee, The data science workflow_
...
2. **Data collection**: You gather or access data that can answer the question: databases, exports, APIs, surveys, or partners. You also record _where_ data came from and _when_, so later analyses stay trustworthy.
...
Imagine an online shop asks: _"Are weekend discount emails worth the cost?"_
...
You have reached the end of submodule 1.1. Continue to [Introduction to Python](../1.2-intro-python/), or return to the [module 1 overview](../).
